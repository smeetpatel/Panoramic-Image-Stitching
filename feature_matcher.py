...
if __name__ == '__main__':
    user_input = input()
    image1 = Image(user_input)
    image1.detect_harris_corners()

    user_input = input()
    image2 = Image(user_input)
    image2.detect_harris_corners()

    """kp, matches = utl.get_matches(image1.corners, image2.corners)
    print("Matches found: ", len(matches))
    keypoints_1 = []
    for i in kp:
       keypoints_1.append(image1.keypoints[i])

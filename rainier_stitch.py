...
1) Implementation of stitching algorithm to stitch multiple images:
...
if __name__ == '__main__':
    ransac_match_images = ['project_images/Rainier1.png', 'project_images/Rainier2.png', 'project_images/Rainier3.png',
                           'project_images/Rainier4.png', 'project_images/Rainier5.png', 'project_images/Rainier6.png']
    images = []
    ...
    cv2.imwrite('Results/project_images/All_Rainier_stitched.png', final_image)